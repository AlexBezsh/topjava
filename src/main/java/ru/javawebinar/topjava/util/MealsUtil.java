...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(3, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500),
            new Meal(3, LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед", 1000),
            ...
            new Meal(5, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин", 410)
    );
